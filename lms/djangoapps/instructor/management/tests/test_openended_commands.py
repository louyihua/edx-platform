...
class OpenEndedPostTest(ModuleStoreTestCase):
    ...
    def test_post_submission_for_student_on_initial(self):
        ...
        dry_run_result = post_submission_for_student(self.student_on_initial, course, self.problem_location, self.task_number, dry_run=True)
        self.assertFalse(dry_run_result)

        result = post_submission_for_student(self.student_on_initial, course, self.problem_location, self.task_number, dry_run=False)
    ...
    def test_post_submission_for_student_on_accessing(self):
        ...
        dry_run_result = post_submission_for_student(self.student_on_accessing, course, self.problem_location, self.task_number, dry_run=True)
        self.assertFalse(dry_run_result)
        ...
        with patch('capa.xqueue_interface.XQueueInterface.send_to_queue') as mock_send_to_queue:
            ...
            task = module.child_module.get_task_number(self.task_number)
            ...
            result = post_submission_for_student(self.student_on_accessing, course, self.problem_location, self.task_number, dry_run=False)
    ...
    def test_post_submission_for_student_on_post_assessment(self):
        ...
        dry_run_result = post_submission_for_student(self.student_on_post_assessment, course, self.problem_location, self.task_number, dry_run=True)
        self.assertFalse(dry_run_result)

        result = post_submission_for_student(self.student_on_post_assessment, course, self.problem_location, self.task_number, dry_run=False)
        self.assertFalse(result)

    def test_post_submission_for_student_invalid_task(self):
        course = get_course_with_access(self.student_on_accessing, self.course_id, 'load')
        invalid_task_number = 3

        result = post_submission_for_student(self.student_on_accessing, course, self.problem_location, invalid_task_number, dry_run=False)
        self.assertFalse(result)
